...
<title>Sprite Locker &mdash; Fortnite Variant Tracker</title>
<style>
  :root{
...
<div class="wrap">
  <div class="top">
    <div class="ring">
      <svg width="64" height="64"><circle cx="32" cy="32" r="27" stroke="#20305e" stroke-width="7" fill="none"/>
  ...
  <div class="foot">Fortnite Sprite Locker &middot; fan-made collection tracker &middot; progress stored locally in your browser</div>
</div>
